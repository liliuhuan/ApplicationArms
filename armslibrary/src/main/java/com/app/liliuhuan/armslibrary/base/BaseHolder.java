...
import com.app.liliuhuan.armslibrary.util.ThirdViewUtil;
...
public abstract class BaseHolder<T> extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    /**
     * 在 Activity 的 onDestroy 中使用 {@link BaseRecyclerViewAdapter#releaseAllHolder(RecyclerView)} 方法 (super.onDestroy() 之前)
